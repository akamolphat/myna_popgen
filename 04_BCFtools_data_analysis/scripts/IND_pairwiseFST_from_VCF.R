...
# Add spreadsheet with popdef1 matrix instead of pop_INDrecode
write.xlsx(fstmat2$Fsts, file = outputxlsx, sheetName = "FST_100bs_popdef1", append = T)
write.xlsx(fstmat2$Pvalues, file = outputxlsx, sheetName = "pval_100bs_popdef1", append = T)
write.xlsx(fstmat2$Bootstraps, file = outputxlsx, sheetName = "FST_100bs_val_popdef1", append = T)
write.xlsx(reichfstmat2$fsts, file = outputxlsx, sheetName = "ReichFST_100bs_popdef1", append = T)
write.xlsx(reichpvalmat2, file = outputxlsx, sheetName = "Reichpval_100bs_popdef1", append = T)
write.xlsx(reichfstmat2$bootstraps, file = outputxlsx, sheetName = "ReichFST_100bs_val_popdef1", append = T)